# Performance Evaluation Report [cite: 93]

## 1. Evaluation Metrics [cite: 28]
| Metric | Value | Reasoning |
| :--- | :--- | :--- |
| **Precision** | 1.0 | Ensures every flagged alert is a true statistical anomaly[cite: 15, 29]. |
| **Recall** | 0.15 | Strategically low to minimize 'Alert Fatigue' for security analysts[cite: 15, 29]. |
| **F1-Score** | 0.25 | Represents a conservative balance favoring high-certainty alerts. |
| **Accuracy** | 0.98 | High stability in identifying baseline 'Normal' behavior[cite: 28]. |
